...
\begin{figure}
\centering
\includegraphics[width=14cm, height=12cm]{images/popN.png}
...
\begin{figure}
\centering
\includegraphics[width=14cm, height=12cm]{images/routine.jpg}
...
\begin{figure}
\centering
\includegraphics[width=18cm, height=8cm]{images/schemaRoutine.PNG}
\caption{Architecture de gestion des routines}
\label{fig:modele}
\end{figure}
