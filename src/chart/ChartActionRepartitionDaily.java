...
public class ChartActionRepartitionDaily extends JFrame{
	...
	private DefaultCategoryDataset createDataset( ){
  		...
  		for(int i=0; i<character.getData().getActionRepartitionYesterday().size(); i++)
	  		dataset.addValue(character.getData().getActionRepartitionYesterday().get(i) , "Yesterday" , character.getData().getActionName(i) );
  		for(int i=0; i<character.getData().getActionRepartitionToday().size(); i++)
	  		dataset.addValue(character.getData().getActionRepartitionToday().get(i) , "Today" , character.getData().getActionName(i) );
  		return dataset;
   }
